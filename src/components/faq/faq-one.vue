                    ...
                    <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
                        ...
                        <div class="grid gap-8 sm:grid-cols-2 sm:gap-y-10 xl:grid-cols-3">
                            <div class="relative rounded-lg bg-gray-100 p-5 pt-8">
                                ...
                                <h3 class="mb-3 text-lg font-semibold text-indigo-500 md:text-xl">How does the product
                                    work?</h3>
                            ...
                            <div class="relative rounded-lg bg-gray-100 p-5 pt-8">
                                ...
                                <h3 class="mb-3 text-lg font-semibold text-indigo-500 md:text-xl">What are the features?
                                </h3>
                                <p class="text-gray-500">This is a section of some simple filler text, also known as
                                    placeholder text. It shares some characteristics of a real written text.</p>
                            </div>
                            ...
                            <div class="relative rounded-lg bg-gray-100 p-5 pt-8">
                                ...
                                <h3 class="mb-3 text-lg font-semibold text-indigo-500 md:text-xl">What about
                                    integrations?</h3>
                                <p class="text-gray-500">This is a section of some simple filler text, also known as
                                    placeholder text. It shares some characteristics of a real written text.</p>
                            </div>
                            ...
                            <div class="relative rounded-lg bg-gray-100 p-5 pt-8">
                                ...
                                <h3 class="mb-3 text-lg font-semibold text-indigo-500 md:text-xl">Is support available?
                                </h3>
                                <p class="text-gray-500">This is a section of some simple filler text, also known as
                                    placeholder text. It shares some characteristics of a real written text.</p>
                            </div>
                            ...
                            <div class="relative rounded-lg bg-gray-100 p-5 pt-8">
                                ...
                                <h3 class="mb-3 text-lg font-semibold text-indigo-500 md:text-xl">How does one upgrage a
                                    plan?</h3>
                                <p class="text-gray-500">This is a section of some simple filler text, also known as
                                    placeholder text. It shares some characteristics of a real written text.</p>
                            </div>
                            ...
                            <div class="relative rounded-lg bg-gray-100 p-5 pt-8">
                                ...
                                <h3 class="mb-3 text-lg font-semibold text-indigo-500 md:text-xl">Which payment methods
                                    are available?</h3>
                                <p class="text-gray-500">This is a section of some simple filler text, also known as
                                    placeholder text. It shares some characteristics of a real written text.</p>
                            </div>
