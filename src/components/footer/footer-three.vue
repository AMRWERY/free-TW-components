                ...
                <footer class="bg-white">
                    <div class="pb-16 pt-4 sm:pt-10 lg:pt-12">
                        <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
                            <div
                                class="grid grid-cols-2 gap-12 border-t pt-10 md:grid-cols-4 lg:grid-cols-6 lg:gap-8 lg:pt-12">
                                <div class="col-span-full lg:col-span-2">
                                    ...
                                    <p class="text-gray-500 sm:pr-8">Filler text is dummy text which has no meaning
                    ...
                    <div class="bg-gray-100">
                        <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
                            <div class="flex items-center justify-between gap-4 py-8">
                                <span class="text-sm text-gray-400"> © 2021 - Present Flowrift. All rights reserved.
                                </span>
