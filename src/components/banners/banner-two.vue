    ...
    <div>
        <div class="bg-white pt-6 sm:pt-8 lg:pt-12">
            <div class="mx-auto max-w-screen-2xl px-4 pb-4 md:px-8">
                <div
                    class="relative flex flex-wrap rounded-lg bg-indigo-500 px-4 py-3 shadow-lg sm:flex-nowrap sm:items-center sm:justify-center sm:gap-3 sm:pr-8 md:px-8">
                    <div
                        class="order-1 mb-2 inline-block w-11/12 max-w-screen-sm text-sm text-white sm:order-none sm:mb-0 sm:w-auto md:text-base">
                        This is a section of some simple filler text, also known as placeholder text.</div>
                    ...
                    <div
                        ...
                        <button type="button"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 xl:h-6 xl:w-6" fill="none"
        ...
        <div class="mt-8 p-4 border rounded-md bg-gray-100">
            <h3 class="text-lg font-semibold mb-2">Code to Copy:</h3>
            <div class="relative bg-gray-800 text-white p-4 rounded-md">
                <pre><code>{{ componentCode }}</code></pre>
                <button @click="() => onCopy(componentCode)" :disabled="copied"
                    class="absolute top-2 right-2 px-3 py-1 rounded-md text-sm font-medium" :class="{
...
const componentCode = ref(`<div class="bg-white pt-6 sm:pt-8 lg:pt-12">
            <div class="mx-auto max-w-screen-2xl px-4 pb-4 md:px-8">
                <div
                    class="relative flex flex-wrap rounded-lg bg-indigo-500 px-4 py-3 shadow-lg sm:flex-nowrap sm:items-center sm:justify-center sm:gap-3 sm:pr-8 md:px-8">
                    <div
...
const { copied, onCopy } = useClipboardExample(componentCode);
</script> -->
