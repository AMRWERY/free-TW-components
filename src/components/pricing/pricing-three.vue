                            ...
                            <div class="flex flex-col overflow-hidden rounded-lg border sm:mt-8">
                                ...
                                <div class="flex flex-1 flex-col p-6 pt-8">
                                    <div class="mb-12">
                                        ...
                                        <p class="mb-8 px-8 text-center text-gray-500">For individuals and organizations
                                            who want to try our system</p>
                                        <div class="space-y-4">
                            ...
                            <div class="flex flex-col overflow-hidden rounded-lg border-2 border-indigo-500">
                                ...
                                <div class="flex flex-1 flex-col p-6 pt-8">
                                    <div class="mb-12">
                                        ...
                                        <p class="mx-auto mb-8 px-8 text-center text-gray-500">Avanced feaures for
                            ...
                            <div class="flex flex-col overflow-hidden rounded-lg border lg:mt-8">
                                ...
                                <div class="flex flex-1 flex-col p-6 pt-8">
                                    <div class="mb-12">
                                        ...
                                        <p class="mx-auto mb-8 px-8 text-center text-gray-500">Maximum performace for
                                            organisations</p>
                                        <div class="space-y-4">
                                            <div class="flex items-center gap-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 shrink-0"
                                    ...
                                    <div class="mt-auto">
                                        <a href="#"
                                            class="block rounded-lg bg-gray-800 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-indigo-300 transition duration-100 hover:bg-gray-700 focus-visible:ring active:bg-gray-600 md:text-base">$49</a>
                                    </div>
                                </div>
                            </div>
                        </div>
