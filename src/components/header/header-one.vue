            ...
            <div v-if="showPreview" class="rounded-md shadow-sm overflow-hidden">
                <div class="bg-white lg:pb-12">
                    <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
                        ...
                        <div
                            class="mx-auto -mt-4 hidden w-full max-w-screen-sm overflow-hidden rounded-lg border bg-white shadow-sm lg:block">
                            <div class="m-6 mb-10 grid grid-cols-2 gap-8">
                                <a href="#" class="group flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">This is a section of some simple filler text,
                            ...
                            <a href="#"
                                ...
                                <p class="text-sm text-gray-500">This is a section of some simple filler text.</p>
                            </a>
                        </div>
                    </div>
                </div>
