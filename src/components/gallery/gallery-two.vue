                    ...
                    <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
                        <div class="mb-4 flex items-center justify-between gap-8 sm:mb-8 md:mb-12">
                            <div class="flex items-center gap-12">
                                ...
                                <p class="hidden max-w-screen-sm text-gray-500 md:block">This is a section of some
                                    simple filler text, also known as placeholder text. It shares some characteristics
                                    of a real written text.</p>
                            </div>
                            <a href="#"
                        ...
                        <div class="grid grid-cols-2 gap-4 sm:grid-cols-3 md:gap-6 xl:gap-8">
                            <a href="#"
                                ...
                                <span
                                    class="relative ml-4 mb-3 inline-block text-sm text-white md:ml-5 md:text-lg">VR</span>
                            </a>
                            ...
                            <a href="#"
                                ...
                                <span
                                    class="relative ml-4 mb-3 inline-block text-sm text-white md:ml-5 md:text-lg">Tech</span>
                            </a>
